package com.samples.ws.cxf.client;
...
import com.samples.ws.cxf.model.Patient;

public class PatientWSClient {

	private static final String PATIENTS = "/patients";
	private static final String PATIENT_SERVICE_URL = "http://localhost:8080/spring-demo/services/patientservice";
